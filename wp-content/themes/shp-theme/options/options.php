...
define('MTS_TYPOGRAPHY_DEFAULT_OPT', SHOP_THEME.'_typography_default');
define('MTS_TYPOGRAPHY_COLLECTIONS_OPT', SHOP_THEME.'_typography_collections');
...
function mts_fields_to_fix_after_import( $field, $value ) {
	...
	if ( isset( $field['type'] ) ) {
		...
		update_option( SHOP_THEME.'_fix_fields_after_import', $fields_arr );
	}
}
