 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
		...
		public function process_imports() {
			...
			$imported_demos = get_option( SHOP_THEME.'_imported_demos', array() );
			...
			$demo_content_imported = get_option( SHOP_THEME.'_demo_content_imported', false );
			...
			update_option( SHOP_THEME.'_imported_demos', $imported_demos );
		...
		public function backup_widgets() {
			...
			if ( !isset( $imported_demos['widgets'] ) ) {
				$sidebars_widgets = get_option( 'sidebars_widgets' );
				if ( $sidebars_widgets ) {
					update_option( SHOP_THEME.'_import_sidebars_widgets_backup', $sidebars_widgets );
		...
		public function backup_options() {
			...
			if ( !isset( $imported_demos['options'] ) ) {
				...
				if ( $mts_options ) {
					update_option( SHOP_THEME.'_import_options_backup', $mts_options );
		...
		public function restore_widgets() {
			...
			$sidebars = get_option( SHOP_THEME.'_import_sidebars_widgets_backup' );
			if ( $sidebars ) {
		...
		public function restore_options() {
			...
			$options = get_option( SHOP_THEME.'_import_options_backup' );
			if ( $options ) {
				update_option( SHOP_THEME, $options );
		...
		public function remove_imports() {
			...
			delete_option( SHOP_THEME.'_import_sidebars_widgets_backup' );
			delete_option( SHOP_THEME.'_import_options_backup' );
			delete_option( SHOP_THEME.'_imported_terms' );
			delete_option( SHOP_THEME.'_imported_posts' );
			delete_option( SHOP_THEME.'_imported_images' );
			delete_option( SHOP_THEME.'_imported_demos' );
			delete_option( SHOP_THEME.'_demo_content_imported' );
		}
		...
		public function mts_correct_imported_options( $opt ) {
			...
			$imported_terms_opt = get_option( SHOP_THEME.'_imported_terms', array() );
			$imported_posts_opt = get_option( SHOP_THEME.'_imported_posts', array() );
			$mts_imported_images = get_option( SHOP_THEME.'_imported_images', array() );
			$fields_arr = get_option( SHOP_THEME.'_fix_fields_after_import', array() );
