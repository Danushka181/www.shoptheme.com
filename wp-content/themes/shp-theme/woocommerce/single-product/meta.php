...
$cat_count = ( get_the_terms( $post->ID, 'product_cat' ) ) ? get_the_terms( $post->ID, 'product_cat' ) : '';
$tag_count = ( get_the_terms( $post->ID, 'product_tag' ) ) ? get_the_terms( $post->ID, 'product_tag' ) : '';
